...
import {
  ...
  RequestExtraBudgetNextWeek
} from '../../../functions/DepartmentAccess/function_dep';
import { useFocusEffect } from '@react-navigation/native';
const DepartmentRequestBudgetNextWeek = () => {
  ...
  const handleAllocateSubmit = async () => {
    ...
    if (selectedCategory && price && selectedCategoryallocationId && selectedCategoryid) {
      try {
        const response = await RequestExtraBudgetNextWeek(
          selectedCategory,
          parseFloat(price),
          message,
...
export default DepartmentRequestBudgetNextWeek;
