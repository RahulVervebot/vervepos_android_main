// screens/TopCustomersPaymentReport.js (or keep your original name)
...
const PaymentReport = () => {
  ...
  // Initialize tz + default to Today (UTC+offset), exact formatting
  useEffect(() => {
    const init = async () => {
      try {
  ...
  return (
    <Provider>
      <View style={[
        ...
        {/* 🔁 Replaced Dialog/FlatList/DateTimePicker with the reusable selector */}
        ...
        {endDate && startDate ? (
          <Button
            ...
            onPress={() => {
              ...
              navigation.navigate('TopCustomerReport', {
                startDate,
                endDate,
                numCustomers: numCustomers || '20',
              });
            }}
