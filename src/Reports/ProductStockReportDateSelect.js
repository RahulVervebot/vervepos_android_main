import {
  ...
  const ProductStockReportDateSelect = ({navigation}) => {
    ...
    return (
      <View>
          ...
          {isCustom === true ? (
            <>
              <TouchableOpacity
                ...
                {startDate ? (
                  <Text style={{fontSize:20}}>{startDate?.split('T')[0]}</Text>
                ) : (
                  <Text style={{fontSize:17,color:'#3399ff'}} >Select Start Date</Text>
                )}
              </TouchableOpacity>
              <TouchableOpacity
                ...
                {endDate ? (
                  <Text style={{fontSize:20}} >{endDate?.split('T')[0]}</Text>
                ) : (
                  <Text style={{fontSize:17,color:'#3399ff'}}>Select End Date</Text>
                )}
              </TouchableOpacity>
            </>
          ) : (
        ...
        {endDate && startDate ? (
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('ProductStockReport', {
                startDate:
                  startDate?.split('T')[0] +
                  ' ' +
  ...
  export default ProductStockReportDateSelect;
