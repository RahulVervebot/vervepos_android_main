...
import { View, StyleSheet,Dimensions, TouchableOpacity, ScrollView, TextInput, Image, Pressable, Modal, ActivityIndicator, ImageBackground } from 'react-native';
...
const DepartmentAccount = () => {
  ...
  const fetchData = async (warehouseIdParam = selectedWarehouseId) => {
    ...
    try {
      const allocationDetails = await getTotalAllocationCurrentWeek();
      console.log("warehouseIdParam:",warehouseIdParam);
      if (
        allocationDetails &&
        allocationDetails.status === 'success' &&
        Array.isArray(allocationDetails.data) &&
        ...
        if (selectedBudget) {
          ...
          const allocated_amount = 0;
           const remaining_allocated_amount = 0;
            const remainingPOBalance = 0;
            const usedallocated = 0;
      setAllocationData({ allocated_amount, remaining_allocated_amount, remainingPOBalance, usedallocated });
        }
      }
    } catch (error) {
            ...
            <View
              ...
              <View style={styles.warehousecatainer}>
                <View
                  ...
                  <Image
                    style={styles.graph}
                    source={require('../../src/images/WarehouseIcon.png')}
                  />
                  <Text style={{ textAlign: 'left', fontWeight: '700', fontSize: 16, marginLeft: "5%" }}>
              ...
              <View style={styles.budgetWarehouseButtons}>
                {appType === 'warehouse' ?
                  ...
                  >
                    <Text style={styles.buttonWarehouseText}>Select Warehouse</Text>
                  </TouchableOpacity>
                  :
                  <Text></Text>
                }
              ...
              <View style={styles.warehousecatainer}>
                <View
                  ...
                  <Image
                    style={styles.graph}
                    source={require('../../src/images/CalenderIcon.png')}
                  />
            ...
            <View
              ...
              <View style={styles.budgetcontainer}>
                  ...
                  {loading ?
                    ...
                    :
                    <Text style={{ textAlign: 'left', fontWeight: '700', fontSize: 24, color: '#2B6FA0' }}>
                      ${allocationData.allocated_amount.toFixed(2)}
                    </Text>
                  }
              ...
              <View style={styles.budgetusedcontainer}>
                  ...
                  {loading ?
                    ...
                    :
                    <Text style={{ textAlign: 'left', fontWeight: '700', fontSize: 24, color: '#C80122' }}>
                      ${allocationData.usedallocated ? allocationData.usedallocated.toFixed(2) : 0}
                    </Text>
                  }
            ...
            <View
              ...
              <View style={styles.container}>
                <TouchableOpacity
                  ...
                  <Image
                    style={styles.logo}
                    source={require('../../src/images/Department-Budget-Icon.png')}
                  />
              ...
              <View style={styles.container}>
                <TouchableOpacity style={{ alignItems: 'center' }}
                  ...
                  />
                  <Text style={{ textAlign: 'center', fontWeight: '700', fontSize: 18 }}>VENDOR REPORT</Text>
                </TouchableOpacity>
              </View>
              {/* )  */}
            </View>
