  ...
  return (
   ...
   <Text variant="titleMedium" style={styles.titleTextWhite}>Remaining Budget(loading)</Text>
      ...
      :
        ...
        />
        <View >
        <Text variant="titleMedium" style={styles.titleTextWhite}>Remaining Budget(${allocationData.remaining_allocated_amount.toFixed(2)})</Text>
          ...
          <View style={{ marginTop: '5%' }}>
            ...
            <View
              ...
              <View
                ...
                <View style={styles.container}>
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate('VendorPOData')}>
                    <Image
                      style={styles.logo}
                  ...
                  <View style={styles.container}>
                    <TouchableOpacity
                      style={{ alignItems: 'center' }}
                      onPress={() => navigation.navigate('POTopSheet')}>
                      <Image
                        style={styles.logo}
              ...
              <View style={styles.container}>
                    <TouchableOpacity
                      style={{ alignItems: 'center' }}
                      onPress={() => navigation.navigate('RequestVendorBudget')}>
                  ...
                  <View style={styles.container}>
                    <TouchableOpacity
                      ...
                      onPress={() => 
                        {
                          navigation.navigate('PONextWeek')
                        }
                      }>
                  ...
                  <View style={styles.container}>
                    <TouchableOpacity
                      style={{ alignItems: 'center' }}
                      onPress={() => navigation.navigate('RequestAmountNextWeek')}>
